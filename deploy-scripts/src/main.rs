...
async fn main() -> Result<(), Error> {
    ...
    let init_method_name: &str = "init_ccdpiggybank"; // Example
    ...
    use ccdpiggybank::MyInputType; // Example
    ...
    let update_payload = transactions::UpdateContractPayload {
        ...
        receive_name: OwnedReceiveName::new_unchecked("ccdpiggybank.receive".to_string()),
